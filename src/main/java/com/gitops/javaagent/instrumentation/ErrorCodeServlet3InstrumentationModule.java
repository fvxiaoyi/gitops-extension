...
public final class ErrorCodeServlet3InstrumentationModule extends InstrumentationModule {
  public ErrorCodeServlet3InstrumentationModule() {
  ...
  public List<TypeInstrumentation> typeInstrumentations() {
    return singletonList(new ErrorCodeServlet3Instrumentation());
  }
}
